...
def test_adobe_users_config(default_args, config_files, modify_root_config):
    # test default
...
def test_extension_load(modify_root_config, monkeypatch, config_files, default_args, cleanup):
    ...
    with monkeypatch.context() as m:
        ...
        modify_root_config(['directory_users', 'extension'], config_files['extension'])
        options = ConfigLoader(default_args).get_rule_options()
        assert 'after_mapping_hook' in options and options['after_mapping_hook'] is not None


def test_extension_flag(modify_root_config, monkeypatch, config_files, default_args, cleanup):
