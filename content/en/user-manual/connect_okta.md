...
See [Security Recommendations]({{< ref "security#secure-credential-storage" >}})
for more information.
...
See the [LDAP config page]({{< ref "connect_ldap#attribute-mapping-options" >}}) for more information.
