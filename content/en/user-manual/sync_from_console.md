...
Users]({{< ref "sign_sync#sign-enterprise" >}}).
...
integration on the Adobe Developer Console]({{< ref "setup_and_installation#adobe-developer-console-setup" >}}).
...
> migrate your integration, please refer to [this guide]({{< ref "connect_adobe#migrating-from-jwt-to-server-to-server" >}}). It is geard to
> the UMAPI connector, but the procedure for migrating Admin Console connector
> config is very similar.
