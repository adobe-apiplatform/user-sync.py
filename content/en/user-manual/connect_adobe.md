...
This section focuses on a single connection. See the [advanced config]({{< ref
"advanced_configuration#accessing-groups-in-other-organizations" >}}) section
for details around synchronizing to multiple UMAPI targets.

Before configuring any UMAPI connections, you must set up an integration for
each target. See the [Setup and Installation]({{< ref
"setup_and_installation#adobe-developer-console-setup" >}}) page for more
information.
...
- `oauth` (**recommended**) - Use OAuth Server-to-Server authentication. This is
  ...
  [Setup and Installation]({{< ref
  "setup_and_installation#adobe-developer-console-setup" >}}) for more info.
...
options]({{< ref "security#dealing-with-ssl-issues" >}}) have been exhausted.
...
Recommendations]({{< ref "security#secure-credential-storage" >}}) for more
information.
