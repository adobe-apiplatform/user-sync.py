...
See [Security Recommendations]({{< ref "security#secure-credential-storage" >}}) for more
information.
...
It may be a better option to use the [extension config]({{< ref
"advanced_configuration#custom-attributes-and-mappings" >}}) to dynamically
