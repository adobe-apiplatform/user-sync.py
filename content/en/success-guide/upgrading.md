...
* Private key encryption and decryption - `./user-sync encrypt` and `./user-sync
  decrypt`
...
* See the
  [changelog](https://raw.githubusercontent.com/adobe-apiplatform/user-sync.py/v2/.changelog/changelog.md)
  for more details
...
The UST development team generally targets the environments supported by Github
Actions.
...
| Ubuntu Jammy 22.04 | Y | Use `ubuntu-jammy` build | {: .bordertablestyle }
