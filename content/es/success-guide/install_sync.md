...
![instalación](/user-sync.py/images/es/install_finding_releases.png)

Seleccione “versión”

![instalación2](/user-sync.py/images/es/install_release_screen.png)
...
![instalación2](/user-sync.py/images/es/install_config_files.png)
