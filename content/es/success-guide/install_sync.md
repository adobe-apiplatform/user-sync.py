...
![instalación](/user-sync.py/images/install_finding_releases.png)

Seleccione “versión”

![instalación2](/user-sync.py/images/install_release_screen.png)
...
![instalación2](/user-sync.py/images/install_config_files.png)
