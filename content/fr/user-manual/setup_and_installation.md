...
Prenez note des noms que vous donnez à ces groupes et identifiez les groupes Adobe auxquels ils correspondent. Vous allez utiliser ces informations pour configurer un mappage dans le fichier de configuration principal de User Sync. Reportez-vous aux instructions détaillées dans la section [Configuration d’un mappage de groupe]({{< ref "configuring_user_sync_tool#configuration-dun-mappage-de-groupe" >}}) ci-dessous.
...
![Figure 2: Présentation du mappage de groupe](/user-sync.py/images/group-mapping.png)
