...
![Figure 1: Flux de données User Sync](/user-sync.py/images/fr/adobe-to-enterprise-connections.png)
...
Pour plus d’informations sur les modèles d’utilisation et la façon de les appliquer, reportez-vous à la section [Scénarios d’utilisation]({{< ref "usage_scenarios#scénarios-d-utilisation" >}}) ci-après.
