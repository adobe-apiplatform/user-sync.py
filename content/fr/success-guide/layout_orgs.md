...
![Configuration simple](/user-sync.py/images/layout_orgs_simple.PNG)
...
![Configuration multiple](/user-sync.py/images/layout_orgs_multi.png)
...
![Organisations et annuaires multiples](/user-sync.py/images/layout_orgs_multi_dir_multi_org.png)
...
![Annuaires multiples et organisation unique](/user-sync.py/images/layout_orgs_multi_dir_single_org.png)
