...
![install](/user-sync.py/images/install_finding_releases.png)

Sélectionnez « release ».

![install2](/user-sync.py/images/install_release_screen.png)
...
![install2](/user-sync.py/images/install_config_files.png)
