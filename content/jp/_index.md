...
User Sync を開始するための最も早い方法は、必要な構成ファイルの設定とツールの実行の手順を詳細に説明している[セットアップと成功のガイド]({{< ref "success-guide" >}})を読むことです。

# ユーザーマニュアル

様々な標準用途向けに設定する方法など、User Sync の使用について詳しくは、[ユーザーマニュアル]({{< ref "user-manual" >}})を参照してください。お客様のディレクトリ情報と Adobe 側のデータ間のカスタムマッピングをおこなう手順も記載されているので、User Sync の動作のカスタマイズの開始点にもなります。

# よく寄せられる質問

寄せられた多くの質問と予想されるその他の質問に対する回答を[よく寄せられる質問のドキュメント]({{< ref "faq" >}})にまとめました。
