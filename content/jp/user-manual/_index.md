...
![Figure 1:User Sync のデータの流れ](/user-sync.py/images/jp/adobe-to-enterprise-connections.png)
...
使用モデルとその実装方法について詳しくは、後述の「[使用シナリオ]({{< ref "usage_scenarios#使用シナリオ" >}})」セクションを参照してください。
