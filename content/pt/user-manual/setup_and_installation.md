...
seção [Configurar mapeamento de grupo]({{< ref "configuring_user_sync_tool#configure-group-mapping" >}}) abaixo
.
...
a seção a seguir,
[Configuração da ferramenta User Sync]({{< ref "configuring_user_sync_tool#configuring-the-user-sync-tool" >}}).)
...
definir.  Consulte a seção [Recomendações de segurança]({{< ref "deployment_best_practices#security-recommendations" >}})
...
[Recomendações de segurança]({{< ref "deployment_best_practices#security-recommendations" >}}).
