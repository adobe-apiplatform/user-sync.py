...
[descrição abaixo]({{< ref "advanced_configuration#managing-users-with-adobe-ids" >}}) em
[Configuração avançada]({{< ref "advanced_configuration#advanced-configuration" >}}) se for assim
...
![Figura 3: Captura de tela do Admin Console](/user-sync.py/images/pt/edit-product-config.png)
