...
[Guia de instalação e sucesso]({{< ref "success-guide" >}}), que fornece instruções
...
o [Manual do usuário]({{< ref "user-manual" >}}). Ele também é o seu ponto de partida
...
Compilamos um [documento de perguntas frequentes]({{< ref "faq" >}}) que responde a muitas perguntas que nos foram feitas e a outras possíveis dúvidas.
