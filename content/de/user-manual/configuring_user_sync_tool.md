...
Wie Sie ab Version 2.1 des Benutzer-Synchronisationstools das Kennwort sicherer speichern, erfahren Sie unter [Hinweise zur Sicherheit]({{< ref "deployment_best_practices.md#sicherheitsempfehlungen" >}}).
...
- Im Abschnitt **adobe_users** wird festgelegt, wie das Benutzer-Synchronisationstool über die User Management API eine Verbindung mit der Adobe Admin Console herstellt. Es muss auf die separate, sichere Konfigurationsdatei verweisen, in der die Anmeldeinformationen für den Zugriff gespeichert sind. Dies wird im Feld „umapi“ des Felds „connectors“ festgelegt.
    - Der Abschnitt „adobe_users“ kann zudem „exclude_identity_types“, „exclude_adobe_groups“ und „exclude_users“ enthalten, die den Bereich der Benutzer beschränken, welche von der Benutzersynchronisation betroffen sind. Dies wird ausführlicher im Abschnitt [Schützen bestimmter Konten vor Löschung durch die Benutzersynchronisation]({{< ref "advanced_configuration.md#schützen-bestimmter-konten-vor-löschung-durch-die-benutzersynchronisation" >}}) weiter unten beschrieben.
