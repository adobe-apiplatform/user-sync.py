...
Ab Release 2.1 des Benutzer-Synchronisationstools können Sie Anmeldeinformationen im sicheren Anmeldeinformationsspeicher des Betriebssystems speichern, anstatt sie in Dateien zu speichern und diese Dateien dann zu sichern, oder umapi- und ldap-Konfigurationsdateien sicher mit einem von Ihnen definierten Verfahren speichern. Im Abschnitt [Sicherheitsempfehlungen]({{< ref "deployment_best_practices#sicherheitsempfehlungen" >}}) finden Sie weitere Informationen.
...
Wenn Sie die Anmeldeinformationen im Betriebssystem speichern, erstellen Sie die gleichen Konfigurationsdateien, speichern aber nicht die tatsächlichen Anmeldeinformationen, sondern Schlüssel-IDs, mit denen die Anmeldeinformationen abgerufen werden. Im Abschnitt [Sicherheitsempfehlungen]({{< ref "deployment_best_practices#sicherheitsempfehlungen" >}}) finden Sie weitere Informationen.
