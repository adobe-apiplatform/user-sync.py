...
![Installation](/user-sync.py/images/install_finding_releases.png)

Wählen Sie „release“.


![Installation 2](/user-sync.py/images/install_release_screen.png)
...
![Installation 2](/user-sync.py/images/install_config_files.png)
